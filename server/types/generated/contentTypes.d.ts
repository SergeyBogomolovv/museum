...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<['about.image', 'about.text']> &
...
export interface ApiBookVisitPageBookVisitPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::book-visit-page.book-visit-page'>
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime
    sections: Schema.Attribute.Component<'layout.footer-section', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
...
export interface ApiMainPageMainPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    details: Schema.Attribute.Component<'main.details', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
      }>
    features: Schema.Attribute.Component<'main.feature-card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
      }>
    hero: Schema.Attribute.Component<'main.hero', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
...
export interface ApiVisitBookingVisitBooking extends Struct.CollectionTypeSchema {
  collectionName: 'visit_bookings'
  info: {
    description: ''
    displayName: 'VisitBooking'
    pluralName: 'visit-bookings'
    singularName: 'visit-booking'
  }
  options: {
    draftAndPublish: true
  }
  attributes: {
    ...
    bookingStatus: Schema.Attribute.Enumeration<['pending', 'confirmed', 'cancelled']> &
      Schema.Attribute.DefaultTo<'pending'>
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    email: Schema.Attribute.Email
    isAdminEmailSent: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>
    isUserEmailSent: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::visit-booking.visit-booking'> &
      Schema.Attribute.Private
    name: Schema.Attribute.String
    publishedAt: Schema.Attribute.DateTime
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::visit-booking.visit-booking': ApiVisitBookingVisitBooking
